  ...
  return (
    <section>
        <div className="p-10 flex flex-col items-start">
            ...
            <p className="text-xl w-1/2">Have any questions, concerns, or need assistance? Fill out the form below and one of our representatives will reach out to you in a timely manner.</p>
        </div>
        <div className="p-10 flex flex-row items-start">
            <div className="mb-10 md:mb-0 md:mr-10 w-full md:w-1/2">
                ...
                <form className="space-y-4">
                    ...
                    />
                    <div> 
                        <button className='w-full text-center bg-primary-purple py-3 rounded-3xl text-[12px] text-white font-semibold 2xl:py-5 2xl:rounded-full' type='submit'>Submit</button>
                    </div>
                </form>
            </div>
            <div className="bg-yellow-500 w-full md:w-1/3 rounded-2xl text-primary-brown">
                <div className="p-5 font-medium">
                    ...
                    <div className="flex space-x-3 mt-4">
                        <a href="#" className="w-15 h-15 rounded-full flex items-center justify-center text-white hover:bg-purple-800 transition duration-300">
                            <Image src="/footer/Twitter.svg" width={40} height={40} alt='Twitter' />
                        </a>
                        <a href="#" className="w-15 h-15 rounded-full flex items-center justify-center text-white hover:bg-purple-800 transition duration-300">
                            <Image src="/footer/Facebook.svg" width={40} height={40} alt='Twitter' />
                        </a>
                        <a href="#" className="w-15 h-15 rounded-full flex items-center justify-center text-white hover:bg-purple-800 transition duration-300">
                            <Image src="/footer/Youtube.svg" width={40} height={40} alt='Twitter' />
                        </a>
                    </div>
                </div>
            </div>
