      ...
      <div ref={popupRef} className="absolute w-[30vw] h-[60vh] bg-primary-skin rounded-2xl bottom-[15vh] right-[5vw] px-[2vw] py-[3vh]" style={avatar !== selectedAvatar ? { height: "60vh" } : {}}>
        ...
        <div className='grid grid-cols-3 grid-rows-2 mt-[3vh] gap-y-6'>
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[1])} style={avatars[1] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar default.svg" fill alt='' />
          </div>
          ...
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[2])} style={avatars[2] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 2.svg" fill alt='' />
          </div>
          ...
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[3])} style={avatars[3] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 3.svg" fill alt='' />
          </div>
          ...
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[4])} style={avatars[4] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 4.svg" fill alt='' />
          </div>
          ...
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[5])} style={avatars[5] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 5.svg" fill alt='' />
          </div>
          ...
          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[6])} style={avatars[6] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 6.svg" fill alt='' />
          </div>

          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[8])} style={avatars[8] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar container 8.svg" fill alt='' />
          </div>

          <div className='relative w-[13vh] h-[13vh] rounded-full border-primary-purple' onClick={() => setSelectedAvatar(avatars[7])} style={avatars[7] == selectedAvatar ? { borderWidth: "3px" } : {}}>
            <Image src="/profile/Settings/Avatar 7.svg" fill alt='' />
          </div>

        </div>
        {selectedAvatar !== avatar && <div className='flex w-full justify-end'>
          <Button3 text='Save changes' style={{ marginTop: "10px", width: "9vw" }} onClick={submitNewAvatar} />
...
const avatars = {
  1: "/profile/Settings/Avatar default.svg",
  2: "/profile/Settings/Avatar 2.svg",
  3: "/profile/Settings/Avatar 3.svg",
  4: "/profile/Settings/Avatar 4.svg",
  5: "/profile/Settings/Avatar 5.svg",
  6: "/profile/Settings/Avatar 6.svg",
  7: "/profile/Settings/Avatar 7.svg",
  8: "/profile/Settings/Avatar container 8.svg",
}
