  ...
  return (
    <AuthorizedWrapper1 pageTitle={authorizedWrapperTitles.Dashboard} openedLink={nav4leftLinks.dashboard}>
        <div className="relative flex h-[94%] mt-[1.5%] overflow-y-auto z-30">
            <div className="w-[60%]">
                <h1 className="text-primary-brown text-6xl 3xl:text-7xl 4xl:text-8xl font-semibold">Morning Jack!</h1>
                ...
                <div className="relative w-[80vh] h-[80vh]">
                    <div className="absolute w-[80%] h-[85%] z-30 left-[10%] top-[10%]">
                        <div className="flex justify-between select-none mt-[2%] mb-[3%]">
