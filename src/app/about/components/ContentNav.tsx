...
export default function ContentNav({page}: {page: string}) {
  return (
    <div className='flex gap-px h-12' style={{width: '70%'}}>
        <Link 
            className='flex-1 flex justify-center items-center p-8 rounded-tl' style={{fontSize: "12px", backgroundColor: page !== pages.whyChooseUs ? '#FFEBD5': '#D8BCFD'}}
        ...
        <Link className='flex-1 flex justify-center items-center p-8 rounded-tr' style={{fontSize: "12px", backgroundColor: page !== pages.FAQs ? '#FFEBD5': '#D8BCFD'}} href="/about/FAQs"><p  style={{}}className='text-primary-brown font-bold'>FAQs</p></Link>
    </div>
  )
}
