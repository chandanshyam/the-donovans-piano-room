...
export default function ContentNav({page}: {page: string}) {
  return (
    <div className='flex gap-px h-12' style={{width: '70%'}}>
        ...
        <Link className='flex-1 flex justify-center items-center p-8' style={{fontSize: "12px", backgroundColor: page !== aboutNavigationPages.membership ? '#FFEBD5': '#D8BCFD'}} href="/about/membership"><p style={{}} className='text-primary-brown font-bold'>Membership</p></Link>
        <Link className='flex-1 flex justify-center items-center p-8 rounded-tr-xl' style={{fontSize: "12px", backgroundColor: page !== aboutNavigationPages.FAQs ? '#FFEBD5': '#D8BCFD'}} href="/about/FAQs"><p  style={{}}className='text-primary-brown font-bold'>FAQs</p></Link>
    </div>
  )
}
