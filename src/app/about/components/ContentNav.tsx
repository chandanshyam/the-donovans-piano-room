...
export default function ContentNav({page}: {page: string}) {
  return (
    <div className='flex w-9/12 gap-px h-12'>
        <Link 
            className={'flex-1 flex justify-center items-center '} style={{backgroundColor: page !== pages.whyChooseUs ? '#FFC89599': '#D8BCFD'}}
        ...
        <Link className={'flex-1 flex justify-center items-center'} style={{backgroundColor: page !== pages.FAQs ? '#FFC89599': '#D8BCFD'}} href="/about/FAQs"><p>FAQs</p></Link>
    </div>
  )
}
