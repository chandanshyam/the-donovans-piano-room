...
export default function WhatsIncludedContent() {
  return (
    <div className='flex flex-col justify-center items-center h-full gap-[5%]'>
        ...
        <div className='flex items-center justify-around w-full h-[56%]'>
            <div className='w-[18%] h-full bg-white border-2 border-[#FCF0D8] rounded-3xl shadow-[#AC7A2280] shadow-[rgba(0,0,15,0.5)_2px_3px_4px_0px] px-12 py-5'>
                <Image src="/about/scholarship/what-is-included/Icon1.svg" height={50} width={50} alt=''/>
                <h4 className='text-2xl mt-4 laptop:mt-8 laptop:text-3xl desktop:text-5xl'>Free Access to The Donovan&apos;s Piano Room</h4>
            ...
            <div className='w-[18%] h-full bg-white border-2 border-[#FCF0D8] rounded-3xl shadow-[#AC7A2280] shadow-[rgba(0,0,15,0.5)_2px_3px_4px_0px] px-12 py-5'>
                ...
                <h4 className='text-2xl mt-4 laptop:mt-8 laptop:text-3xl desktop:text-5xl'>Range of Learning Opportunities</h4>
            ...
            <div className='w-[18%] h-full bg-white border-2 border-[#FCF0D8] rounded-3xl shadow-[#AC7A2280] shadow-[rgba(0,0,15,0.5)_2px_3px_4px_0px] px-12 py-5'>
                ...
                <h4 className='text-2xl mt-4 laptop:mt-8 laptop:text-3xl desktop:text-5xl'>Inclusive Learning Environment</h4>
            ...
            <div className='w-[18%] h-full bg-white border-2 border-[#FCF0D8] rounded-3xl shadow-[#AC7A2280] shadow-[rgba(0,0,15,0.5)_2px_3px_4px_0px] px-12 py-5'>
                ...
                <h4 className='text-2xl mt-4 laptop:mt-8 laptop:text-3xl desktop:text-5xl'>Flexible Learning Options</h4>
