...
export default function LoginForm() {
    ...
    return (
        ...
        <div className='mb-5 2xl:mt-5 2xl:mb-[20px]'>
            ...
            <div className="flex justify-between w-full">
                ...
                <div className="flex items-center">
                    ...
                    <label className="text-lg font-medium text-white mt-1 2xl:mt-2 2xl:text-xl">Remember me</label>
                </div>
                <Link href="/forgot-password" className="text-lg font-medium text-primary-yellow mt-3 2xl:mt-4 2xl:text-xl">Forgot password?</Link>
            </div>
            <div> 
        ...
        <p className='w-full text-center mt-[10px] text-lg text-white bg-primary-purple py-3 rounded-3xl text-[12px] mt-9 2xl:py-5 2xl:rounded-full'>Don&apos;t have an account? <Link href="/signup" className='text-primary-yellow underline'>Sign up</Link></p>
