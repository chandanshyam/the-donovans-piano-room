...
export default function InputForm({
  ...
  return (
    <div>
      <FormControl variant="filled" sx={{paddingBottom: "4px", border: 1, borderColor: '#391f0f'}} className='bg-[#fef8ee] block rounded-3xl w-full 2xl:mb-[25px] 2xl:py-2' error={!!error}>
