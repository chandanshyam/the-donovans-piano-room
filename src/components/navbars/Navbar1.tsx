...
export default function Navbar1({page}: {page: string}) {
  ...
  return (
    <nav className='fixed top-0 w-full z-40 bg-white z-50'>
        ...
        <div className='flex float-right h-24 p-y-50 mr-36 gap-16'>
            ...
            <Link className='text-primary-purple text-xl font-bold flex items-center relative' style={navigationPages.contact === page ? highlightLink: {}} href="#">
             <p>CONTACT</p>
