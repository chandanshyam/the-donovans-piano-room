...
export default function Navbar2(){
  return (
    ...
    <div className='fixed h-[8.8vh] w-[100vw] backdrop-blur-sm z-40'></div>
    <nav className='fixed top-0 w-full z-40 border-b-2 border-[#A135E8] py-2 z-50 h-[9vh]'>
        <div className='absolute bg-[#601D86] h-[8.8vh] w-[24vw] pr-4 py-2 rounded-r-full top-0'>
              <Image src="/navbar/Logo2.svg" fill alt='The Donovan&apos;s Piano Room' />
