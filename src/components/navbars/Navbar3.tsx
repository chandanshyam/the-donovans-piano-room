  ...
  return (
    <nav className='fixed top-0 w-full z-40 border-b-2 border-[#A135E8] h-[8vh] z-50 backdrop-blur-sm'>
        ...
        <div className='flex float-right h-full py-50 mr-36 gap-16'>
            ...
            <Link className='text-primary-purple hover:text-[#E98427] active:text-[#Da6a1c] text-xl 3xl:text-2xl 4xl:text-3xl font-bold flex items-center relative'style={navigationPages.games === page ? highlightLink: {}} href="#">
              <p>GAMES</p>
