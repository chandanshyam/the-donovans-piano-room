...
export default function Footer2() {
  return (
    <div className='fixed flex justify-center items-center bottom-0 w-full border-t-2 border-[#A135E8] h-[9.3vh] mb-8'>
        ...
        <div className='flex justify-between h-[28px] w-[84.7%] z-50'>
            ...
            <div className='flex gap-8'>
                <Image src="/footer/YellowTwitter.svg" width={50} height={50} alt='Twitter' />
                <Image src='/footer/YellowFacebook.svg' width={50} height={50} alt='Facebook' />
                <Image src='/footer/YellowYoutube.svg' width={50} height={50} alt='Youtube' />
            </div>
        </div>
    </div>
  )
