...
export default function Footer2() {
  return (
    <div className='fixed flex justify-center items-center bottom-0 w-full border-t-2 border-[#A135E8] backdrop-blur-sm h-[9.3vh] z-40 mb-5'>
        <div className='flex justify-between h-[28px] w-[84.7%] z-50'>
            ...
            <div className='flex gap-8'>
                ...
                <div className="relative h-[6vh] w-[6vh]">
