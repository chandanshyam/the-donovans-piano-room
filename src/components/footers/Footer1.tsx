...
export default function Footer1() {
  return (
    <div className='fixed flex justify-center items-center bottom-0 w-full border-t-2 border-t-primary-purple h-[9vh]'>
        <div className='fixed h-[8.8vh] w-[100vw] backdrop-blur-lg z-40'></div>
